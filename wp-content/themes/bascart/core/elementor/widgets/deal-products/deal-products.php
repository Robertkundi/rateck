...
class Bascart_Deal_Products extends Widget_Base {
	...
	public function get_title() {
		...
		return esc_html__('Deal Products', 'bascart');
	...
	protected function register_controls() {
		...
		*/
		...
		$this->product_settings_controls(['badge', 'title', 'hover', 'price', 'category', 'swatches']);

		$this->add_control(
			'deals_settings',
			[
				'label'     => esc_html__('Deals:', 'bascart'),
		...
		$this->add_control(
			'hide_deals',
			[
				'label'       => esc_html__('Hide Deals', 'bascart'),
				...
				'default'     => '',
				'selectors'   => [
					'{{WRAPPER}} .product-end-sale-timer' => 'display: none;'
				]
			]
		);
