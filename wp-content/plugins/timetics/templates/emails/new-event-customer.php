<?php
    ...
    $booking_cancel_url = $this->meeting->get_appointment_permalink() . '?id=' . $this->booking->get_id() . '&booking_action=cancel';
    $booking_reschedule_url = $this->meeting->get_appointment_permalink() . '?id=' . $this->booking->get_id() . '&booking_action=reschedule';
        ...
        <div class="email-content" style="padding: 40px; background-color: #ffffff; border-radius: 0 0 12px 12px; border-top: 4px solid #3161F1; margin-bottom: 40px;">
            ...
            <div class="email-title">
                <h3 style="color: #3161F1; font-size: 24px; font-weight: 600; margin: 30px 0;">
                    <?php echo timetics_replace_placeholder( $email_title, $placeholders ); ?>
                </h3>
            </div>
            <?php if ( $email_body ): ?>
            ...
            <?php else: ?>
                ...
                <div class="data-wrapper" style="border: 1px solid #E2ECF4; border-radius: 12px; padding: 30px; margin: 24px 0;">
                    ...
                    <div class="single-data-entry" style="margin: 0 0 20px;">
                        <p style="font-weight: 600; font-size: 14px; line-height: 1; color: #0C274A; margin: 0 0 5px;"><?php echo esc_html__( 'Host:', 'timetics' ); ?></p>
                        <p style="font-weight: 400; font-size: 14px; color: #556880; margin: 0;">
