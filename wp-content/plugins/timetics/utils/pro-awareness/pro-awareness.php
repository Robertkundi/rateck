...
if(!class_exists('\Wpmet\Libs\Pro_Awareness')) :
	...
	class Pro_Awareness
    {
		...
		public static function enqueue_scripts() {
			$tw_welcome_image = TIMETICS_PLUGIN_URL . 'utils/pro-awareness/assets/welcome_image.png';
			$tw_setup_image = TIMETICS_PLUGIN_URL . 'utils/pro-awareness/assets/setup_wizard.png';
			echo "
			<script>
