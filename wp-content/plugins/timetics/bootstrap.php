...
final class Bootstrap {
    ...
    public function admin_scripts( $handle ) {
        ...
        if (!empty($calendar_locale)) {
            wp_enqueue_script( 'calendar-locale', "https://npmcdn.com/flatpickr/dist/l10n/{$calendar_locale}.js", [ 'jquery', 'wp-plugins', 'wp-i18n', 'wp-element', 'wp-dom', 'wp-data' ], TIMETICS_VERSION, true );
        }
