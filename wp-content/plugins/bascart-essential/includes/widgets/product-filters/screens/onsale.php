<?php
	...
	$onsale = [
		'on_sale' => esc_html__('On Sale', 'bascart-essential'),
		'regular_price' => esc_html__('Regular Price', 'bascart-essential')
	];
			...
			<div class="filter-input-group">
				...
				<label class="shopengine-filter-onsale-label" for="<?php echo esc_attr($id) ?>">
					<span class="shopengine-checkbox-icon">
						<span>
							<?php \Elementor\Icons_Manager::render_icon($settings['shopengine_check_icon'], ['aria-hidden' => 'true']); ?>
						</span>
					</span>
