...
class ElementsKit_Widget_Instagram_Feed extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Layout Settings ', 'bascart-essential'),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__('Grid Style', 'bascart-essential'),
				'type'               => Controls_Manager::SELECT,
				'frontend_available' => true,
				'default'            => 'layout-masonary',
				'options'            => [
					'layout-list'     => esc_html__('List', 'bascart-essential'),
					'layout-grid'     => esc_html__('Grid', 'bascart-essential'),
					'layout-masonary' => esc_html__('Masonary', 'bascart-essential'),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__('Columns Grid', 'bascart-essential'),
				'type'               => Controls_Manager::SELECT,
				'frontend_available' => true,
				'default'            => 'ekit-insta-col-4',
				'options'            => [
					'ekit-insta-col-auto' => esc_html__('1 Columns', 'bascart-essential'),
					'ekit-insta-col-6'    => esc_html__('2 Columns', 'bascart-essential'),
					'ekit-insta-col-4'    => esc_html__('3 Columns', 'bascart-essential'),
					'ekit-insta-col-3'    => esc_html__('4 Columns', 'bascart-essential'),
					'ekit-insta-col-2'    => esc_html__('6 Columns', 'bascart-essential'),
				],
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__('Feed Style', 'bascart-essential'),
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__('Show Post', 'bascart-essential'),
				'type'               => Controls_Manager::NUMBER,
				'frontend_available' => true,
				'default'            => esc_html__(9, 'bascart-essential'),
				'min'                => 1,
				'max'                => 100,
				'step'               => 1,
			]
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Display Settings ', 'bascart-essential'),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__('Profile Header', 'bascart-essential'),
				'type'               => Controls_Manager::SWITCHER,
				'frontend_available' => true,
				'label_on'           => esc_html__('Show', 'bascart-essential'),
				'label_off'          => esc_html__('Hide', 'bascart-essential'),
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__('Profile Settings', 'bascart-essential'),
				'type'               => Controls_Manager::SELECT,
				'frontend_available' => true,
				'default'            => 'both',
				'options'            => [
					'only-profile' => esc_html__('Only Profile Image', 'bascart-essential'),
					'only-name'    => esc_html__('Only Name', 'bascart-essential'),
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__('Profile Style', 'bascart-essential'),
				'type'               => Controls_Manager::SELECT,
				'frontend_available' => true,
				'default'            => 'circle',
				'options'            => [
					'circle' => esc_html__('Circle', 'bascart-essential'),
					'square' => esc_html__('Square', 'bascart-essential'),
				],
				'condition'          => [
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__('Show Date', 'bascart-essential'),
				'type'               => Controls_Manager::SWITCHER,
				'frontend_available' => true,
				'label_on'           => esc_html__('Show', 'bascart-essential'),
				'label_off'          => esc_html__('Hide', 'bascart-essential'),
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__('Show Comment Box', 'bascart-essential'),
				'type'               => Controls_Manager::SWITCHER,
				'frontend_available' => true,
				'label_on'           => esc_html__('Show', 'bascart-essential'),
				'label_off'          => esc_html__('Hide', 'bascart-essential'),
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__('Enable Follow Button', 'bascart-essential'),
				'type'               => Controls_Manager::SWITCHER,
				'frontend_available' => true,
				'label_on'           => esc_html__('Show', 'bascart-essential'),
				'label_off'          => esc_html__('Hide', 'bascart-essential'),
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__('Follow Button Text', 'bascart-essential'),
				'type'               => Controls_Manager::TEXT,
				'frontend_available' => true,
				'default'            => esc_html__('Follow On Instagram', 'bascart-essential'),
				'placeholder'        => esc_html__('Follow Text', 'bascart-essential'),
				'label_block'        => true,
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__('Follow link', 'bascart-essential'),
				'type'               => Controls_Manager::TEXT,
				'frontend_available' => true,
				'default'            => esc_html__($this->ekit_ins_follow, 'bascart-essential'),
				'placeholder'        => esc_html__('Follow Link', 'bascart-essential'),
				'label_block'        => true,
				'condition'          => ['ekit_instagram_feed_enable_follow' => 'yes'],
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Container', 'bascart-essential'),
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__('Container margin Bottom', 'bascart-essential'),
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__('Gutter', 'bascart-essential'),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__('Container Spacing', 'bascart-essential'),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'     => esc_html__('Name', 'bascart-essential'),
		...
		$this->add_responsive_control(
			...
			[
				'label'     => esc_html__('Date', 'bascart-essential'),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Favourite', 'bascart-essential'),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Comment', 'bascart-essential'),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__('Media', 'bascart-essential'),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'ekit_instagram_feed_style' => 'yes',
				],
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__('Grayscale', 'bascart-essential'),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['%'],
				'range'      => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__('Button', 'bascart-essential'),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
            ...
            <div class="ekit-insta-row <?php echo esc_attr($masnory_column . ' ' . $styleLayout . ' ' . $row_class); ?>">
				...
				if(!empty($data)){
					foreach($data->data as $no => $ins_post) {
						...
						$userInfo = (function_exists('bascart_option'))? bascart_option('instagram_username'): '';
