...
class ElementsKit_Widget_Woo_Mini_Cart extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Cart Visibility', 'bascart-essential' ),
        ...
        $this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Cart Button', 'bascart-essential' ),
        ...
        $this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Item', 'bascart-essential' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Border Width', 'bascart-essential' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Quantity:', 'bascart-essential' ),
                'type' => Controls_Manager::HEADING,
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Image:', 'bascart-essential' ),
                'type' => Controls_Manager::HEADING,
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Remove:', 'bascart-essential' ),
                'type' => Controls_Manager::HEADING,
            ]
        );
        ...
        $this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Subtotal', 'bascart-essential' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Price:', 'bascart-essential' ),
                'type' => Controls_Manager::HEADING,
            ]
        );
        ...
        <div class="ekit-mini-cart">
            ...
            <div class="ekit-dropdown-back ekit-mini-cart-visibility-<?php echo esc_attr( $settings['ekit_woo_mini_cart_visibility'] ); ?>" data-toggle="mini-cart-dropdown">
                <?php
                    ...
                    $total_items_in_cart =  WC()->cart && !WC()->cart->is_empty() ?  WC()->cart->get_cart_contents_count() : 0 ;
                ...
                <div class="ekit-basket-item-count" style="display: inline;">
                    <span class="ekit-cart-items-count count">
                        <?php
                            echo esc_html($total_items_in_cart);
                        ?>
                    </span>
                </div>
                <!-- Cart Title -->
                <?php if('yes' == $settings['ekit_woo_mini_cart_show_title']) : ?>
                    <p class="mini-cart-title">
                        <?php echo esc_html($settings['ekit_woo_mini_cart_title']); ?>
                    </p>
                <?php endif; ?>
                <div class="ekit-mini-cart-container">
                        ...
                        <ul>
                            <li>
                                <span class="ekit-cart-count">
                                    ...
                                    esc_html_e($total_items_in_cart);
                                    esc_html_e(($total_items_in_cart < 2 ? ' item': ' items'), 'bascart-essential' ); 
                    ...
                    <div class="view-cart">
                        <a class="button view-cart-btn dd" href="<?php echo esc_url( wc_get_cart_url() ); ?>"><?php esc_html_e( 'view cart', 'bascart-essential' ); ?></a>
                    </div>
                </div>
            </div>
        </div>
