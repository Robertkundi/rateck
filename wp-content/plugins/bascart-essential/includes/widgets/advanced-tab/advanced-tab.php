...
class ElementsKit_Widget_Advanced_Tab extends Widget_Base {
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_tab', [
                'label' =>esc_html__( 'Advanced Tab', 'bascart-essential' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'horizontal',
                'options' => [
                    'horizontal' =>esc_html__( 'Horizontal', 'bascart-essential' ),
                    'vertical' =>esc_html__( 'Vertical', 'bascart-essential' ),
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'ekit_tab_nav_width',
            [
                'label' => esc_html__( 'Vertical Nav Width', 'bascart-essential' ),
            ...
            [
                ...
                'options' => [
                    ...
                    'elementskit_tooltip_style' => [
                        'title' => esc_html__( 'image style 2', 'bascart-essential' ),
                    ...
                    'elementskit_heartbit_style' => [
                        'title' => esc_html__( 'image style 3', 'bascart-essential' ),
                    ...
                    'elementskit_pregress_style' => [
                        'title' => esc_html__( 'image style 4', 'bascart-essential' ),
                    ...
                    'elementskit_ribbon_style' => [
                        'title' => esc_html__( 'image style 5', 'bascart-essential' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Full Width Nav', 'bascart-essential' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'bascart-essential' ),
                'label_off' => esc_html__( 'Hide', 'bascart-essential' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Nav Icon Position', 'bascart-essential' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'left-pos',
                'options' => [
                    'right-pos'  => esc_html__( 'Right', 'bascart-essential' ),
                    'left-pos' => esc_html__( 'Left', 'bascart-essential' ),
                    'top-pos' => esc_html__( 'Top', 'bascart-essential' ),
                    'bottom-pos' => esc_html__( 'Bottom', 'bascart-essential' ),
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_responsive_control(
            ...
            [
                'label' =>esc_html__( 'Nav Alignment', 'bascart-essential' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' =>esc_html__( 'Nav Content Alignment', 'bascart-essential' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'flex-start'    => [
                        'title' =>esc_html__( 'Left', 'bascart-essential' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' =>esc_html__( 'Nav Item Alignment', 'bascart-essential' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left'    => [
                        'title' =>esc_html__( 'Left', 'bascart-essential' ),
        ...
        $this->add_control(
            'ekit_hash_change',
            [
                'label'                 => esc_html__( 'Enable URL Hash', 'bascart-essential' ),
                'type'                  => Controls_Manager::SWITCHER,
                'return_value'          => '1',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Toggle Type', 'bascart-essential' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'click',
                'options' => [
                    'click' => esc_html__( 'Click', 'bascart-essential' ),
                    'mouseenter' => esc_html__( 'Hover', 'bascart-essential' ),
                ],
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__('Keep this tab open? ', 'bascart-essential'),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
        ...
        $repeater->add_control(
            'ekit_tab_title_icon_type', [
                'label'       => esc_html__( 'Icon Type', 'bascart-essential' ),
                'type'        => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options'     => [
                    'none' => [
                        'title' => esc_html__( 'None', 'bascart-essential' ),
                        'icon'  => 'fa fa-ban',
                    ],
                    'icon' => [
                        'title' => esc_html__( 'Icon', 'bascart-essential' ),
                        'icon'  => 'fa fa-paint-brush',
                    ],
                    'image' => [
                        'title' => esc_html__( 'Image', 'bascart-essential' ),
                        'icon'  => 'fa fa-image',
                    ],
                ],
                'default'       => 'icon',
        ...
        $repeater->add_control(
            'ekit_tab_title_icons', [
                'label' => esc_html__('Title Icon', 'bascart-essential'),
        ...
        $repeater->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Title Border Radius', 'bascart-essential' ),
        ...
        $this->add_control(
            'ekit_tab_items',
            [
                'label' => esc_html__('Tab content', 'bascart-essential'),
        ...
        $this->start_controls_section(
            'ekit_tab_header_section_setting', [
                'label' =>esc_html__( 'Nav Wrapper  ', 'bascart-essential' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Make Fluid', 'bascart-essential' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Yes', 'bascart-essential' ),
                'label_off' => esc_html__( 'No', 'bascart-essential' ),
                'return_value' => 'yes',
        ...
        $this->start_controls_section(
            'ekit_tab_nav_items_section_setting', [
                'label' =>esc_html__( 'Nav Items  ', 'bascart-essential' ),
                'tab'	 => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                'label' =>esc_html__( 'Title Color', 'bascart-essential' ),
        ...
        $this->add_control(
            'ekit_tab_icon_color',
            [
                'label' =>esc_html__( 'Icon Color', 'bascart-essential' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'First and Last Child Border Radius', 'bascart-essential' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'First Child Border Radius', 'bascart-essential' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%' ],
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'First Child Border Width', 'bascart-essential' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px'],
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Last Child Border Radius', 'bascart-essential' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%' ],
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Last Child Border Width', 'bascart-essential' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px'],
                'selectors' => [
        ...
        $this->start_controls_section(
            'ekit_tab_header_caret_section_setting', [
                'label' =>esc_html__( 'Caret  ', 'bascart-essential' ),
                'tab'	 => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'ekit_tab_caret_style_choose' => 'yes'
                ]
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Bottom Icon Position', 'bascart-essential' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%' ],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Bottom Line', 'bascart-essential' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%' ],
                'range' => [
                    '%' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Hear Symbol Background', 'bascart-essential' ),
                'types' => [ 'classic', 'gradient' ],
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Caret Width', 'bascart-essential' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Caret Height', 'bascart-essential' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Bottom Position', 'bascart-essential' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%' ],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Left Position', 'bascart-essential' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%' ],
                'range' => [
                    'px' => [
        ...
        $this->start_controls_section(
            'ekit_tab_section_body_style', [
                'label'	 =>esc_html__( 'Body', 'bascart-essential' ),
                'tab'	 => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'ekit_tab_body_color',
            [
                'label' => esc_html__( 'Body Color', 'bascart-essential' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#656565',
                'selectors' => [
        ...
        $this->start_controls_section(
            'ekit_tab_section_wrapper_style', [
                'label'	 =>esc_html__( 'Wrapper', 'bascart-essential' ),
                'tab'	 => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_responsive_control(
