...
class ElementsKit_Widget_Gallery extends Widget_Base
{
    ...
    public function get_title() {
        return esc_html__( 'Bascart Gallery', 'bascart-essential' );
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Gallery Content', 'bascart-essential' ),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__( 'Filter Label', 'bascart-essential' ),
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__( 'Add Images', 'bascart-essential' ),
        ...
        $this->add_control(
            'ekit_gallery_style',
            [
                'label' => esc_html__( 'Style', 'bascart-essential' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'grid',
                'options' => [
                    'grid' => esc_html__( 'Grid', 'bascart-essential' ),
                    'masonry' => esc_html__( 'Masonry', 'bascart-essential' ),
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Columns', 'bascart-essential' ),
                'type' => Controls_Manager::SELECT,
                'default' => '3',
                'tablet_default' => '2',
                'mobile_default' => '1',
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Image Aspect Ratio', 'bascart-essential' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Settings', 'bascart-essential' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( '"All" Filter Label', 'bascart-essential' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'All', 'bascart-essential' ),
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label'    => esc_html__( 'Content Alignment', 'bascart-essential' ),
        ...
        $this->add_control(
			...
			[
				...
				'options' => [
					'top' => [
						'title' => esc_html__( 'Top', 'bascart-essential' ),
					...
					'bottom' => [
						'title' => esc_html__( 'Bottom', 'bascart-essential' ),
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Caption', 'bascart-essential' ),
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Description', 'bascart-essential' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'bascart-essential' ),
				'label_off' => esc_html__( 'Hide', 'bascart-essential' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Filter Label', 'bascart-essential' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'bascart-essential' ),
				'label_off' => esc_html__( 'Hide', 'bascart-essential' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Lightbox', 'bascart-essential' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'bascart-essential' ),
				'label_off' => esc_html__( 'Hide', 'bascart-essential' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Lightbox Icon', 'bascart-essential' ),
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Image Slideshow', 'bascart-essential' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'True', 'bascart-essential' ),
				'label_off' => esc_html__( 'Flase', 'bascart-essential' ),
				'return_value' => 'yes',
                'default' => 'yes',
                'condition' => [
                    'ekit_gallery_open_lightbox' => 'yes'
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Ordering', 'bascart-essential' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'default',
                'options' => [
                    'default' => esc_html__( 'Default', 'bascart-essential' ),
                    'random' => esc_html__( 'Random', 'bascart-essential' ),
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Columns Gap', 'bascart-essential' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 5,
                    'unit' => 'px',
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Rows Padding', 'bascart-essential' ),
				...
				'selectors' => [
					'{{WRAPPER}} .elementskit-single-portfolio-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        $this->add_responsive_control(
			'ekit_gallery_rows_gap_margin',
			[
				'label' => esc_html__( 'Rows Margin', 'bascart-essential' ),
				'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
                'default' => [
                    'top' => '0',
				...
				'selectors' => [
					'{{WRAPPER}} .ekit_gallery_grid_item' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        // $this->add_responsive_control(
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Content Padding', 'bascart-essential' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Thumbnails', 'bascart-essential' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $ekit_image_filters = [
            ...
            'opacity' => esc_html__( 'Opacity', 'bascart-essential' ),
            'scale' => esc_html__( 'Scale', 'bascart-essential' ),
            'rotate' => esc_html__( 'Rotate', 'bascart-essential' ),
            'blur' => esc_html__( 'Blur', 'bascart-essential' ),
            'gray-scale' => esc_html__( 'Gray Scale', 'bascart-essential' ),
        ];
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Scale', 'bascart-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Blur', 'bascart-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'range' => [
					'px' => [
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Gray Scale', 'bascart-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'range' => [
					'%' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Tilt', 'bascart-essential' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => '',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Axis', 'bascart-essential' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'both',
                'options' => [
                    'both' => esc_html__( 'Both', 'bascart-essential' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Amount', 'bascart-essential' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 10,
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Depth', 'bascart-essential' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Glare', 'bascart-essential' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'bascart-essential' ),
				'label_off' => esc_html__( 'Hide', 'bascart-essential' ),
				'return_value' => 'yes',
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Perspective', 'bascart-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Caption', 'bascart-essential' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Description', 'bascart-essential' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Link Icon', 'bascart-essential' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'ekit_gallery_open_lightbox' => 'yes',
                ]
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Font Size', 'bascart-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
        ...
        $ekit_image_blend_mode = [
            'normal' => esc_html__( 'Normal', 'bascart-essential' ),
            'multiply' => esc_html__( 'Multiply', 'bascart-essential' ),
            'screen' => esc_html__( 'Screen', 'bascart-essential' ),
            'overlay' => esc_html__( 'Overlay', 'bascart-essential' ),
            'darken' => esc_html__( 'Darken', 'bascart-essential' ),
            'lighten' => esc_html__( 'Lighten', 'bascart-essential' ),
            'color-dodge' => esc_html__( 'Color-dodge', 'bascart-essential' ),
            'color-burn' => esc_html__( 'Color-burn', 'bascart-essential' ),
            'difference' => esc_html__( 'Difference', 'bascart-essential' ),
            'exclusion' => esc_html__( 'Exclusion', 'bascart-essential' ),
            'hue' => esc_html__( 'hue', 'bascart-essential' ),
            'saturation' => esc_html__( 'Saturation', 'bascart-essential' ),
            'color' => esc_html__( 'Color', 'bascart-essential' ),
            'luminosity' => esc_html__( 'Luminosity', 'bascart-essential' ),
        ];
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Blend Mode', 'bascart-essential' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'normal',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Filter', 'bascart-essential' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Filter Style', 'bascart-essential' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'default',
				'options' => [
					'default'  => esc_html__( 'Default', 'bascart-essential' ),
					'style_one' => esc_html__( 'Style One', 'bascart-essential' ),
					'style_two' => esc_html__( 'Style Two', 'bascart-essential' ),
					'style_three' => esc_html__( 'Style Three', 'bascart-essential' ),
					'style_four' => esc_html__( 'Style Four', 'bascart-essential' ),
					'style_five' => esc_html__( 'Style Five', 'bascart-essential' ),
					'style_six' => esc_html__( 'Style Six', 'bascart-essential' ),
					'style_seven' => esc_html__( 'Style Seven', 'bascart-essential' ),
					'style_eight' => esc_html__( 'Style Eight', 'bascart-essential' ),
					'style_nine' => esc_html__( 'Style Nine', 'bascart-essential' ),
					'style_ten' => esc_html__( 'Style Ten', 'bascart-essential' ),
				],
			]
		);
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Nav Fill', 'bascart-essential' ),
				'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_responsive_control(
            ...
            [
                'label'    => esc_html__( 'Filter Items Alignment', 'bascart-essential' ),
                'type'     => Controls_Manager::CHOOSE,
                'options'  => [
                    'flex-start'   => [
                        'title' => esc_html__( 'Left', 'bascart-essential' ),
                    ...
                    'space-between'  => [
                        'title' => esc_html__( 'Justify', 'bascart-essential' ),
        ...
        $this->add_control(
            ...
            [
                'label'    => esc_html__( 'Filter Alignment', 'bascart-essential' ),
                'type'     => Controls_Manager::CHOOSE,
                'options'  => [
                    'left'   => [
                        'title' => esc_html__( 'Left', 'bascart-essential' ),
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Caret', 'bascart-essential' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'bascart-essential' ),
				'label_off' => esc_html__( 'Hide', 'bascart-essential' ),
				'return_value' => 'yes',
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Top', 'bascart-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'range' => [
					'%' => [
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Bottom', 'bascart-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'%' => [
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Left', 'bascart-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Nav Bottom Spacing', 'bascart-essential' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Container Style', 'bascart-essential' ),
