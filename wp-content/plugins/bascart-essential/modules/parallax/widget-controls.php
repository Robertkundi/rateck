...
class ElementsKit_Widget_Effect_Controls{
    ...
    public function register_controls($control, $args)
    {
        $control->start_controls_section(
            'ekit_widget_effects',
            [
                'label' => esc_html__('Bascart Effects', 'bascart-essential'),
        ...
        $control->add_control(
            'ekit_we_effect_on', [
                ...
                'options' => [
                    ...
                    'css' => esc_html__( 'CSS3', 'bascart-essential' ),
                    'tilt' => esc_html__( 'Tilt', 'bascart-essential' ),
                    'onscroll' => esc_html__( 'On scroll', 'bascart-essential' ),
                    'mousemove' => esc_html__( 'On mouse move', 'bascart-essential' ),
                ],
            ]
        );
        ...
        */
        $control->add_control(
            ...
            [
                'label' => esc_html__('CSS Animation', 'bascart-essential'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('On', 'bascart-essential'),
                'render_type' => 'ui',
                'label_off' => esc_html__('Off', 'bascart-essential'),
                'condition' => [
        ...
        $control->add_control(
            ...
            [
                'label' => esc_html__( 'Animation speed', 'bascart-essential' ),
        ...
        */
        $control->add_control(
            ...
            [
                'label' => esc_html__( 'CSS Transform', 'bascart-essential' ),
                'render_type' => 'ui',
                'type' => Controls_Manager::SWITCHER,
                'return_value' => 'yes',
                'condition' => [
        ...
        $control->add_control(
            ...
            [
                'label' => esc_html__( 'Translate', 'bascart-essential' ),
        ...
        $control->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Translate X', 'bascart-essential' ),
        ...
        $control->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Translate Y', 'bascart-essential' ),
                'render_type' => 'ui',
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
        ...
        $control->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Rotate Z', 'bascart-essential' ),
                'render_type' => 'ui',
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
        ...
        $control->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Rotate X', 'bascart-essential' ),
                'render_type' => 'ui',
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
        ...
        $control->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Rotate Y', 'bascart-essential' ),
                'type' => Controls_Manager::SLIDER,
                'render_type' => 'ui',
                'size_units' => ['px'],
                'range' => [
        ...
        $control->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Scale X', 'bascart-essential' ),
                'render_type' => 'ui',
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'default' => [
        ...
        $control->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Scale Y', 'bascart-essential' ),
                'type' => Controls_Manager::SLIDER,
                'render_type' => 'ui',
                'size_units' => ['px'],
                'default' => [
        ...
        $control->add_control(
            ...
            [
                'label' => esc_html__( 'Skew', 'bascart-essential' ),
                'render_type' => 'ui',
                'type' => Controls_Manager::POPOVER_TOGGLE,
                'return_value' => 'yes',
                'condition' => [
        ...
        $control->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Skew X', 'bascart-essential' ),
                'render_type' => 'ui',
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['deg'],
                'range' => [
        ...
        $control->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Skew Y', 'bascart-essential' ),
                'render_type' => 'ui',
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['deg'],
                'range' => [
        ...
        */
        ...
        $control->add_control(
            ...
            [
                'render_type' => 'none',
                'frontend_available' => true,
                'label' => esc_html__('Disable animation in editor ', 'bascart-essential'),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'on',
                'label_on' => esc_html__('On', 'bascart-essential'),
                'label_off' => esc_html__('Off', 'bascart-essential'),
