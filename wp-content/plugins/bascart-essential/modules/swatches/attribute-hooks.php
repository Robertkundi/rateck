	...
	public function add_attr_column_content($columns, $column, $term_id) {
		...
		switch($attr->attribute_type) {
			...
			case Swatches::PA_IMAGE:
				...
				printf('<img class="swatches_thumb swatch_image" src="%s" width="44px" height="44px" alt="%s">', esc_url($image),esc_attr__($alt,'bascart-essential'));
				break;
		...
		switch($type) {
			case Swatches::PA_IMAGE:
                ...
                <div class="shopengine_term_img_thumbnail" style="float:left;margin-right:10px;">
                    <img alt="<?php esc_attr_e($alt,'bascart-essential'); ?>" src="<?php echo esc_url($image) ?>" width="70px" height="70px"/>
                </div>
                ...
                <div style="line-height:60px;">
                    ...
                    <button type="button" class="shopengine_upload_img_button button">
						<?php esc_html_e('Upload image', 'bascart-essential'); ?>
                    </button>
