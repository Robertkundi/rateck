...
class Swatches
{
	...
	public function init() {
		...
		$this->set_attribute_types(self::PA_COLOR, esc_html__('Shopengine Color', 'bascart-essential'));
		$this->set_attribute_types(self::PA_IMAGE, esc_html__('Shopengine Image', 'bascart-essential'));
		$this->set_attribute_types(self::PA_LABEL, esc_html__('Shopengine Label', 'bascart-essential'));
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			[
				'i18n'        => [
					'title'  => esc_html__('Choose an image', 'bascart-essential'),
					'button' => esc_html__('Use image', 'bascart-essential'),
				],
