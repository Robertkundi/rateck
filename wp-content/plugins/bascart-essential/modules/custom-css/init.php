...
class ElementsKit_Custom_Css {
	...
	public function __construct() {
		$this->url = \Bascart_Modules::module_url() . 'custom-css/';
	...
	public function add_controls_section($element, $section_id, $args) {
		...
		if ($section_id == 'section_custom_css_pro') {
			...
			$element->start_controls_section(
				'section_custom_css',
				[
					'label' => __( 'Bascart Custom CSS', 'bascart-essential' ),
			...
			$element->add_control(
				'custom_css_title',
				[
					'raw' => __( 'Add your own custom CSS here', 'bascart-essential' ),
			...
			$element->add_control(
				...
				[
					...
					'label' => __( 'Custom CSS', 'bascart-essential' ),
					'language' => 'css',
					'render_type' => 'ui',
					'show_label' => false,
					'separator' => 'none',
			...
			$element->add_control(
				...
				[
					'raw' => __( 'Use "selector" to target wrapper element. Examples:<br>selector {color: red;} // For main element<br>selector .child-element {margin: 10px;} // For child element<br>.my-class {text-align: center;} // Or use any custom selector', 'bascart-essential' ),
					'type' => Controls_Manager::RAW_HTML,
